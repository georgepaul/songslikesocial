...
class Application_Form_EditGroup extends Application_Form_Main
{
	...
	public function init()
	{
		...
		$this->setDecorators( array(
				array('ViewScript', array('viewScript' => 'forms/EditGroup.phtml'))));
		...
		->setLabel($this->translator->translate('Group Name'))
